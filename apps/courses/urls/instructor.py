...
urlpatterns = [
    ...
    path('courses/', instructor.CourseListView.as_view(),
         name="course_list"),
    path('course/create', instructor.CourseCreateView.as_view(),
         name="course_create"),
    ...
    path('course/<int:course_id>/modules/add',
         instructor.ModuleCreateView.as_view(),
         name='module_add'),
    ...
    path('module/<int:module_id>/content/<model_name>/add/',
         instructor.ContentCreateUpdateView.as_view(),
         name="content_add"),
    ...
    path('content/<int:pk>/delete/',
         instructor.ContentDeleteView.as_view(),
         name='content_delete'),
